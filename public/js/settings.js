...
var WIDTH_OF_HORIZONTAL_RECT = 50;
var HEIGHT_OF_HORIZONTAL_RECT = 130;

var WIDTH_OF_VERTICAL_RECT = 320;
var HEIGHT_OF_VERTICAL_RECT = 60;
...
var SCROLL_LIMIT = { xMin: -3000, yMin: -1712, xMax: 0, yMax: 0 };

var PLAYER_CAMERA_OFFSET = { x: CANVAS_WIDTH_HALF, y: CANVAS_HEIGHT_HALF };

var SPAWN_FOODS_RANGE = {
  xMin: EDGES_PROPERTIES.x + EDGEBOARD_X,
  yMin: EDGES_PROPERTIES.y + EDGEBOARD_Y,
  xMax: 2048,
  yMax: 1024,
};
...
var AI_SNAKES = [
  { type: ENEMY_SNAKES[0], x: 250, y: 250, time_follow: 2000 },
