function CAreYouSurePanel(oParentContainer) {
  ...
  this._init = function () {
    ...
    _oMsgStroke = new createjs.Text(TEXT_ARE_SURE, '30px ' + FONT_GAME, '#3b4930');
    ...
    _oMsg = new createjs.Text(TEXT_ARE_SURE, '30px ' + FONT_GAME, '#79aa71');
  ...
  this.show = function () {
    ...
    createjs.Tween.get(_oContainer, { ignoreGlobalPause: true }).to(
      { alpha: 1 },
      150,
      createjs.quartOut
    );
  ...
  this.unload = function () {
    createjs.Tween.get(_oContainer, { ignoreGlobalPause: true })
