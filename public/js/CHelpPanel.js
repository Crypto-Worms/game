function CHelpPanel(iXPos, iYPos, oSprite) {
  ...
  this._init = function (iXPos, iYPos, oSprite) {
    ...
    var oText1Back = new createjs.Text(TEXT_MOVE, '32px ' + FONT_GAME, '#000000');
    oText1Back.textAlign = 'center';
    oText1Back.lineWidth = 10;
    oText1Back.lineHeight = 44;
    oText1Back.textBaseline = 'middle';
    oText1Back.x = CANVAS_WIDTH * 0.5 - 100;
    oText1Back.y = CANVAS_HEIGHT * 0.5 - 70;
    oText1Back.outline = 4;
    _oGroup.addChild(oText1Back);

    var oText1 = new createjs.Text(TEXT_MOVE, '32px ' + FONT_GAME, '#ff6c00');
    ...
    _oHelpMove = new CAnimHelp(1, CANVAS_WIDTH_HALF, oText1Back.y + 50, _oGroup);
    _oHelpMove.scaleX = 0.1;
    _oHelpMove.scaleY = 0.1;
    ...
    var oText2Back = new createjs.Text(TEXT_EAT, '32px ' + FONT_GAME, '#000000');
    oText2Back.textAlign = 'center';
    oText2Back.lineWidth = 10;
    ...
    var oText2 = new createjs.Text(TEXT_EAT, '32px ' + FONT_GAME, '#ff6c00');
    ...
    _oHelpEat = new CAnimHelp(2, CANVAS_WIDTH_HALF, CANVAS_HEIGHT_HALF + 37, _oGroup);
    _oHelpEat.scaleX = 0.1;
    _oHelpEat.scaleY = 0.1;

    var oText3Back = new createjs.Text(TEXT_AVOID, '32px ' + FONT_GAME, '#000000');
    oText3Back.textAlign = 'center';
    oText3Back.lineWidth = 10;
    oText3Back.lineHeight = 44;
    oText3Back.textBaseline = 'middle';
    oText3Back.x = CANVAS_WIDTH * 0.5 - 150;
    oText3Back.y = CANVAS_HEIGHT * 0.5 + 70;
    oText3Back.outline = 4;
    _oGroup.addChild(oText3Back);

    var oText3 = new createjs.Text(TEXT_AVOID, '32px ' + FONT_GAME, '#ff6c00');
    ...
    _oHelpEnemy = new CAnimHelp(3, CANVAS_WIDTH_HALF + 20, oText3Back.y + 50, _oGroup);
    _oHelpEnemy.scaleX = 0.1;
    _oHelpEnemy.scaleY = 0.1;
