function CGfxButton(iXPos, iYPos, oSprite, oParentContainer) {
  ...
  this._init = function (iXPos, iYPos, oSprite) {
    ...
    _fScaleX = _oButton.scaleX;
    _fScaleY = _oButton.scaleY;
  ...
  this.buttonDown = function () {
    ...
    if (_fScaleX > 0) {
      _oButton.scaleX = _fScaleX - 0.1;
    } else {
      _oButton.scaleX = -_fScaleX - 0.1;
    }
    _oButton.scaleY = _fScaleY - 0.1;
  ...
  this.pulseAnimation = function () {
    _oTween = createjs.Tween.get(_oButton)
      .to(
        { scaleX: _fScaleX * _fScaleX - 0.01, scaleY: _fScaleY * _fScaleY - 0.01 },
        850,
